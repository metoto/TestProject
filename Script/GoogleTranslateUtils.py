...
'x-client-data':'CIu2yQEIorbJAQjEtskBCKmdygEIqKPKAQixp8oBCL+nygEI4qjKARj5pcoBGJeoygE='
  }
  #url=buildUrl(text,js.getTk(text),langId)
  url = buildUrl(text, tk, langId)
  res=''
  try:
      r=requests.get(url)
